...
คุณเพิ่งรันระบบบัญชีของวงจรนี้แบบครบวงจร: บันทึกข้อเสนอถูกสร้างขึ้น ตรวจสอบด้วย lint และถูกรายงาน การตรวจสอบเซนเซอร์ต้องเปิดใช้งานเองผ่าน `--sensors mine` ส่วน wrapper ที่รันตามเวลาจะเปิดใช้งานเป็นค่าเริ่มต้น ยกเลิกทุกอย่างได้ด้วย `rm -rf /tmp/sgl-demo-vault` — ตัวรีโปเองไม่เคยถูกเขียนทับเลย
