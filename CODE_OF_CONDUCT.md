...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers via a GitHub issue marked `question`, or — if the report itself is sensitive — via the private reporting channel described in [SECURITY.md](SECURITY.md). All complaints will be reviewed and investigated promptly and fairly.
